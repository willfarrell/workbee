<div align="center">
  <h1>Workbee <code>precache-json</code></h1>
  <img alt="workbee logo" src="https://raw.githubusercontent.com/willfarrell/workbee/main/docs/img/workbee-logo.svg"/>
  <p><strong>JSON precache manifest extractor for workbee service workers</strong></p>
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@work-bee/precache-json"><img alt="npm version" src="https://img.shields.io/npm/v/@work-bee/precache-json.svg"></a>
  <a href="https://packagephobia.com/result?p=@work-bee/precache-json"><img src="https://packagephobia.com/badge?p=@work-bee/precache-json" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@work-bee/precache-json"><img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@work-bee/precache-json.svg"></a>
  <br/>
...
Extracts a precache route manifest from a JSON response, for use as `precache.extract` in `@work-bee/core`.
...
Full documentation, options and examples: <https://workbee.js.org/docs/packages/precache-json>
