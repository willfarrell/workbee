...
<p>
  ...
  <br/>
  <a href="https://www.npmjs.com/package/@work-bee/logger"><img alt="npm version" src="https://img.shields.io/npm/v/@work-bee/logger.svg"></a>
  <a href="https://packagephobia.com/result?p=@work-bee/logger"><img src="https://packagephobia.com/badge?p=@work-bee/logger" alt="npm install size"></a>
  <a href="https://www.npmjs.com/package/@work-bee/logger"><img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@work-bee/logger.svg"></a>
  <br/>
...
Full documentation, options and examples: <https://workbee.js.org/docs/packages/logger>
